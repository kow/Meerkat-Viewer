...
//#define LL_MINIMIAL_REQUESTED_OPTIONS
	...
	if(STATE_LOGIN_PROCESS_RESPONSE == LLStartUp::getStartupState())
	{
		...
		if(successful_login)
		{
			...
			/* //this is a useless section about teen or adult
			...
			if (LLUserAuth::getInstance()->getOptions("gestures", gesture_options))
			{
					 ...
					 ++resp_it)
				{
					...
					if (item_id.notNull() && asset_id.notNull())
					{
						...
						LLGestureManager::getInstance()->activateGestureWithAsset(item_id, asset_id,
											 no_inform_server,
...
void pass_processObjectPropertiesFamily(LLMessageSystem *msg, void**)
{
	...
	// KOW uncomment these when implementing the new floaters!
