...
void LLFloaterSnapshot::Impl::updateControls(LLFloaterSnapshot* floater)
{
	...
	if(is_advance)
	{
		...
		floater->childSetVisible("type_label3", TRUE) ;
		floater->childSetVisible("local_format_combo", TRUE);
	...
	else
	{
		...
		floater->childSetVisible("type_label3", FALSE) ;
		floater->childSetVisible("local_format_combo", FALSE);
