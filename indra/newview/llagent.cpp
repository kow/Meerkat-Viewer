	...
	BOOL remove )
{
	...
	wearables_to_remove[WT_UNDERSHIRT]	= remove && gRlvHandler.isRemovable(WT_UNDERSHIRT);
	wearables_to_remove[WT_UNDERPANTS]	= remove && gRlvHandler.isRemovable(WT_UNDERPANTS);
