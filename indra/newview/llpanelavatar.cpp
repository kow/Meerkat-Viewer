...
BOOL LLPanelAvatarSecondLife::postBuild(void)
{
	...
	childSetVisible("About:",TRUE);
	childSetVisible("(500 chars)",TRUE);
	childSetVisible("about",TRUE);
	
	childSetVisible("allow_publish",TRUE);
	childSetVisible("?",TRUE);
...
BOOL LLPanelAvatarAdvanced::postBuild()
{
	...
	childSetVisible("skills_edit",TRUE);
	childSetVisible("want_to_edit",TRUE);
